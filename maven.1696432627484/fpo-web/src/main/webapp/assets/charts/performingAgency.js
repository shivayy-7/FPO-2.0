class performingAgency {
	...
	doFetch() {
		...
		url = url + "&chartCall=MNT-TOP-FIVE";
		window.loadCounter++;
...
var chart = am4core.create("performingAgency", am4charts.XYChart);
...
columnTemplate.column.cornerRadius(40, 40, 5, 5);
