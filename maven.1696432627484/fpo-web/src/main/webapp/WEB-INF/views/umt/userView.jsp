										...
										<div class="col-md-12">
											...
											<div class="col-md-3">
												<div class="form-group">
													...
													<div id="hideUserId"> 
													<div class="col-md-12">
														<input type="text" id="username" name="username" value="${userDetails.userName}" class="form-control  form-control-sm" required  readonly onchange="userNameValidation();" maxlength="60">
													</div>
													</div>
												</div>
											</div>
											<div class="col-md-3">
												<div class="form-group">
													...
													<div class="col-md-12">
														<input type="text" id="firstname" name="firstname" value="${userDetails.firstName}" class="form-control  form-control-sm"  readonly required maxlength="100">
													</div>
												</div>
											</div>
											<div class="col-md-3">
												<div class="form-group">
													...
													<div class="col-md-12">
														<input type="text" id="lastname" name="lastname" value="${userDetails.lastName}" class="form-control  form-control-sm" required readonly maxlength="100">
													</div>
												</div>
											</div>
											<%-- <div class="col-md-3">
											...
											<div class="col-md-3">
												<div class="form-group">
													...
													<div class="col-md-12">
														<input type="text" name="userMobile" id="userMobile" class="form-control  form-control-sm" maxlength="10"  value="${userDetails.mobile}" readonly required>
													</div>
												</div>
											</div>
											<div class="col-md-3">
												<div class="form-group">
													...
													<div class="col-md-12">
														<input type="text" name="userEmail" id="userEmail" class="form-control  form-control-sm"  value="${userDetails.email}" required  readonly maxlength="150">  
													</div>
												</div>
											</div> 
											...
											<div class="col-md-3">
												<div class="form-group">
													...
													<div class="col-md-12">
														<input type="text" name="designation" id="designation" class="form-control  form-control-sm"  value="${userDetails.designation}" required readonly maxlength="150">  
													</div>
												</div>
											</div> 
												...
												<table class="table table-bordered table-striped mb-none"  id="tableId1">
													...
													<c:forEach items="${userRoleHcMapList}" var="userRoleHcMapList" varStatus="index"> 
														<tr>
															...
															<td>
																<select class="form-control  form-control-sm" name="isPrimary[]" id="isPrimary${index.count}" disabled="disabled">
																	<option value="">--Select--</option>
															...
															<td>
																<select class="form-control  form-control-sm" name="roleName[]" disabled="disabled" id="roleName${index.count}" data-plugin-selectTwo onchange="checkDuplicate(${index.count},this.value)">
																	<option value="">--Select--</option>
															...
															<td>
																<select class="form-control  form-control-sm" name="status[]" disabled="disabled" id="status${index.count}" >
