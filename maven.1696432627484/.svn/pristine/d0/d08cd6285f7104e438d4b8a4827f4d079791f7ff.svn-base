	...
	<div class="panel-header bg-primary-gradient">
		<div class="page-inner py-4">
			<div class="d-flex align-items-left align-items-md-center flex-column flex-md-row">
				...
				<a href="#" class="btn btn-sm btn-border btn-blue btn-round mr-2">/ User Profile</a>
			</div>
		</div>
	</div>
</div>
<div class="page-inner mt-0 pb-0">
	<div class="row mt-2">
										...
										<div class="col-md-10">
											<div class="col-md-4">
												<div class="form-group">
													...
													<div class="col-md-12">
														<input type="text" id="firstName" name="firstName" value="${userDetails.firstName}" maxlength="150" class="form-control form-control-sm" required="required">
													</div>
												</div>
											</div>
											<div class="col-md-4">
												<div class="form-group">
													...
													<div class="col-md-12">
														<input type="text" id="lastName" name="lastName" value="${userDetails.lastName}" maxlength="150" class="form-control form-control-sm" required="required">
													</div>
												</div>
											</div>
											<div class="col-md-4">
												<div class="form-group">
													...
													<div class="col-md-12">
														<input type="text" name="mobile" id="mobile" class="form-control form-control-sm NumbersOnly" maxlength="10"  value="${userDetails.mobile}" onchange="validateMobileNo(this);" required="required">
													</div>
												</div>
											</div>
											<div class="col-md-4">
												<div class="form-group">
													...
													<div class="col-md-12">
														<input type="text" name="email" id="email" class="form-control form-control-sm emailsOnly"  maxlength="150" onchange="validateEmail(this);"  value="${userDetails.email}" required="required">  
													</div>
												</div>
											</div> 
											<div class="col-md-4">
												<div class="form-group">
													...
													<div id="hideUserId"> 
													<div class="col-md-12">
														<input type="text" id="userName" name="userName" value="${userDetails.userName}" readonly="readonly" maxlength="150" class="form-control form-control-sm" required="required" onchange="userNameValidation();">
													</div>
													</div>
												</div>
											</div>
												...
												<div class="form-group">
													...
													<div class="col-md-12">
														<input type="text" name="designation" id="designation"
															class="form-control form-control-sm" required value="${userDetails.designation}" maxlength="200">
													</div>
												</div>
											</div>
											<%-- <div class="col-md-4">
