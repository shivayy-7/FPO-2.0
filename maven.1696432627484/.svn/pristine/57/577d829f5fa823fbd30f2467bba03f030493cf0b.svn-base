		...
		<div class="page-inner py-4">
			<div class="d-flex align-items-left align-items-md-center flex-column flex-md-row">
				...
				<div class="ml-md-auto mb-4 py-2 py-md-0">
					...
					<a href="#" class="btn btn-sm btn-border btn-blue btn-round mr-2">/ Administration</a>
					...
					<div class="card-body">
						<div class="row">
								...
								<form class="form-horizontal" action="${contextPath}/admin/role/addNupdate" method="POST">
										...
										<div class="col-md-12">
											...
											<div class="col-md-3">
												<div class="form-group">
													...
													<div class="col-md-12">
														<input type="text" id="roleCode" name="roleCode" value="${userDetails.roleCode}" class="form-control form-control-sm" maxlength="50" required="required" onchange="roleCodeValidation();">
													</div>
												</div>
											</div>
											<div class="col-md-3">
									...
									<div class="col-md-12 card-footer text-center mt-2">
