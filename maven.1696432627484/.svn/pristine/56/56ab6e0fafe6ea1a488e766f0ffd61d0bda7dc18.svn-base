							...
							<div class="col-md-12">
								<div class="col-md-3">
									<div class="form-group">
										...
										<div id="hideUserId"> 
										<div class="col-md-12">
											<input type="text" id="username" name="username"  class="form-control form-control-sm" required ${userDetails ne null ? 'readonly' : ''}  onchange="userNameValidation();" maxlength="50" >
										</div>
										</div>
									</div>
								</div>
